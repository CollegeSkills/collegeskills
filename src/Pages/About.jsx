      ...
      <div className="grid items-center grid-cols-1 gap-10 mx-auto max-w-7xl md:grid-cols-2">
        ...
        <div className="relative w-full">
          ...
          {/* Experience Box */}
           ...
           <PartyPopper />
            <p className="text-2xl font-semibold">30 + years of <br />experience</p>
          </div>
        ...
        <div className="flex flex-col gap-6">
          <div>
            ...
            <p className="mt-4 text-base leading-relaxed text-gray-500">
              Receive tailored coaching that empowers you to navigate challenges
              and achieve your personal and professional goals. With expert
              guidance.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-6">
            ...
            <p className="text-sm text-gray-700">
              Join our <span className="font-bold">5000+</span> satisfied client
            </p>
