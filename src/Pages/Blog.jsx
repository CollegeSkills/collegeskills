...
import { Facebook, Instagram, Twitter, Linkedin, Youtube, LinkedinIcon } from "lucide-react";
      ...
      <div className="w-full max-w-[95%] mx-auto text-black bg-white rounded-b-[20px]">
        ...
        <div className="grid grid-cols-1 gap-8 py-8 mx-auto max-w-[95%] md:grid-cols-3">
          ...
          <div className="md:col-span-2">
            ...
            <h3 className="mb-4 text-lg text-gray-500 lg:text-2xl font-oswald">{blog.subtitle}</h3>
